#----------------------------属性の設定----------------------------#
 #-----ストレージ書き換え-----#
  ...
  data merge storage nnsb:player {color:"black"}

 #--------------------------#


 #-----パーティクル-----#
  particle dust 0 0 0 2 ~ ~1.5 ~ 0.5 0.5 0.5 0.1 10 normal @a
 ...
 #-----進捗の削除-----#
  advancement revoke @s only nnsb_main_system:black_potion
