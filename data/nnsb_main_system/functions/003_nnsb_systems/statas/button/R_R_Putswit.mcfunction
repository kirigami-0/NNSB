kill @e[limit=1,sort=nearest,tag=R_R]
...
advancement revoke @s only nnsb_main_system:button/r_r_swith
execute as @e[limit=1,sort=nearest,tag=r_plate] at @s anchored eyes run summon armor_stand ^0.177875 ^1.025 ^ {Tags:["statas_plate","R_R"],Invisible:1b,Invulnerable:1b,NoGravity:1b,ShowArms:1b,ArmorItems:[{},{},{},{}],HandItems:[{id: "minecraft:stone" ,Count:1b,tag:{CustomTags:R_R_PutSwit,CustomModelData:0}},{id: "minecraft:stone" ,Count:1b,tag:{CustomTags:R_R_PutSwit,CustomModelData:0}}],DisabledSlots:4144702}