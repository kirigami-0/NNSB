...
execute as @s at @s run data merge entity @e[nbt={HurtTime:10s},sort=nearest,type=!player,limit=1] {Motion:[0d,1.5d,0d]}
execute at @e[nbt={HurtTime:10s},sort=nearest,type=!player,limit=1] run particle dust 0.169 0.863 1.000 1 ~ ~ ~ 1 1 1 1 30
#進捗はく奪
advancement revoke @s only nnsb_main_system:skill/archer/storm_arrow/p3